...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.copy_code_instructions_pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.copy_code_instructions_pushButton.setObjectName("copy_code_instructions_pushButton")
        self.verticalLayout_2.addWidget(self.copy_code_instructions_pushButton)
        ...
        self.ast_radioButton = QtWidgets.QRadioButton(self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.ast_radioButton.setFont(font)
        self.ast_radioButton.setChecked(True)
        self.ast_radioButton.setObjectName("ast_radioButton")
        self.verticalLayout.addWidget(self.ast_radioButton)
        self.nst_radioButton = QtWidgets.QRadioButton(self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.nst_radioButton.setFont(font)
        self.nst_radioButton.setObjectName("nst_radioButton")
        self.verticalLayout.addWidget(self.nst_radioButton)
        ...
        self.parser_treeWidget.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.parser_treeWidget.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.parser_treeWidget.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        ...
        self.parser_treeWidget.header().setMinimumSectionSize(900)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "左输入框"))
        self.source_code_radioButton.setText(_translate("MainWindow", "源代码"))
        self.code_instructions_radioButton.setText(_translate("MainWindow", "目标代码"))
        self.generate_pushButton.setText(_translate("MainWindow", "运行"))
        self.clear_code_pushButton.setText(_translate("MainWindow", "清空输入"))
        self.reset_pushButton.setText(_translate("MainWindow", "重置全部"))
        self.copy_code_instructions_pushButton.setText(_translate("MainWindow", "复制目标代码结果"))
        self.groupBox_2.setTitle(_translate("MainWindow", "输出"))
        self.label.setText(_translate("MainWindow", "语法分析样式"))
        self.ast_radioButton.setText(_translate("MainWindow", "AST"))
        self.nst_radioButton.setText(_translate("MainWindow", "NST"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "目标代码"))
